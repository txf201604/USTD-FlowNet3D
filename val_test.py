...
def run_test(dataset_name, max_points, path2ckpt, voxel_size):
    ...
    # Load SCTN model
    scene_flow = FPTOT(nb_iter=None, voxel_size=voxel_size)
    device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="HPLFlowNet_kitti",
    ...
    parser.add_argument("--path2ckpt", type=str, default='checkpoints/fpt-model-100.tar', help="Path to saved checkpoint.")
