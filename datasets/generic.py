...
class Batch:
    def __init__(self, batch):
        ...
        coords0_batch, feats0_batch = ME.utils.sparse_collate(coords=coords0, feats=feats0, dtype=coords0[0].dtype)
        coords1_batch, feats1_batch = ME.utils.sparse_collate(coords=coords1, feats=feats1, dtype=coords1[0].dtype)
...
class SceneFlowDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Get sparse indices
        coords0 = pc_0[0] / self.voxel_size
        coords1 = pc_1[0] / self.voxel_size
        #
        feats0 = pc_0[0]
        feats1 = pc_1[0]
